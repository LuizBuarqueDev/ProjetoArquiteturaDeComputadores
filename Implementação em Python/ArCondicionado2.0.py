...
# Variáveis globais para o controle do ar condicionado e temperatura
...
def ligar_evaporadora():
    global evaporadora_ligada
    evaporadora_ligada = False
